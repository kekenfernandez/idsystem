...
<footer class="sticky-footer bg-white">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; SMS Digital System <?= date('Y'); ?></span>
    </div>
  </div>
</footer>
<!-- End of Footer -->
...
<script type="text/javascript" src="<?=base_url('assets/admin/vendor/datatables/datatables.js');?>"></script>
<script src="<?=base_url('assets/admin/vendor/select/js/select2.min.js'); ?> "></script>