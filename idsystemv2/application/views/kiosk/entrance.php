...
<body>
  ...
  ?>
          ...
          <p class="alert alert-secondary alert-sm m-o px-3 interval-alert">
            <?= $this->session->flashdata('timeInterval') ?>
          </p>
          <?php endif;?>

          <div class="card-body text-center py-2">
            <h3 class="card-title mb-1 current-name"><?= $current['full_name']; ?> </h3>
            <a href="#" class="btn btn-success btn-sm current-time">
              <i class="bi bi-box-arrow-in-right"></i>
              IN: <?= ($current['login']) ? $current['login'] : '----- --' ?>
            </a>
          </div>
      ...
      <div class="col-6 d-flex flex-column">
        ...
        <nav class="navbar py-0 mb-3 custom-nav">
          <div class="container-fluid d-flex justify-content-center">
            ...
            <div class="text-center">
              <h4 class="m-0"> <?= $GLOBALS['SCHOOL_SHORT_NAME'];?> | Entrance </h4>
            </div>
          </div>
        </nav>
        <!-- End Nav -->
        ...
        <div class="row mt-auto">
          <div class="col">
            <?= form_open('attendance/entrance', 'id="rfidForm" autocomplete="off"'); ?>
