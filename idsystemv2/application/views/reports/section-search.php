    ...
    <div class="col-md-8">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold text-primary"> Generate Section Report </h6>
          <div id="data-buttons">
          </div>
        </div>
        <div class="card-body">
          <?= form_open('reports/generate_section/'); ?>

          <div class="form-group">
            <label for="sections"> Choose Section </label>
            <select id="sections" class="form-control js-select" name="sections[]" multiple="multiple"
