    ...
    <div class="col">
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold text-primary"> Create SMS for Employees </h6>
          <div id="data-buttons">
          </div>
        </div>
        <div class="card-body">
          <?=form_open('sms/employee_send') ?>
          ...
          <div class="form-group d-flex justify-content-between align-items-center">
            <div class="buttons">
              ...
              <a href="<?=site_url('sms/employees');?>" class="btn btn-secondary btn-icon-split">
                <span class="icon text-white-100">
